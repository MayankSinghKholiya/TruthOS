...
This starts Postgres, Redis, Qdrant, Neo4j, the FastAPI backend
...
The test suite doesn't need Postgres/Redis/Qdrant/Neo4j running - agent and
...
| `TAVILY_API_KEY` | Web search in Hybrid RAG | Web search returns no results; dense/BM25 retrieval over the knowledge base still works |
